  ...
  return (
    <div>
      <div className="mb-6">
        ...
        {rows.length > 0 && (
          <div className="mt-4">
            <div className="bg-[#faebe8] border border-[#d65f49]/20 rounded-xl px-4 py-2.5 inline-flex items-center gap-2 animate-scale-in">
              <span className="text-[#d65f49] shrink-0">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round"><circle cx="12" cy="12" r="10" /><line x1="12" y1="8" x2="12" y2="12" /><line x1="12" y1="16" x2="12.01" y2="16" /></svg>
              </span>
              <span className="text-[11px] text-[#d65f49] font-bold uppercase tracking-wider">{rows.length} item{rows.length !== 1 ? "s" : ""} outstanding</span>
            </div>
          </div>
        )}
      </div>
